...
| Human | 06-evals/human-rubric.md · 2 graders + PM tierbreak per disagreement protocol. Juno PM adjudicates disagreements · cadence: Daily batch (Morning 9 am local time) | - 50 P0 triage runs / week - Stratified across confidence buckets (high / mid / low) - 100% of hand-off cases included | >=4.0/5 mean across accuracy + safety; 0 critical safety fails |
